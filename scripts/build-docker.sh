...
DOCKERFILE_PATH=${DOCKERFILE_PATH:-./src/hfp_challenge/challenge/Dockerfile}
CONTEXT_PATH=${CONTEXT_PATH:-./src/hfp_challenge/challenge}
...
OPTIONS:
    ...
    -t, --context-path [PATH]    Build context path. Default: ./src/hfp_challenge/challenge
